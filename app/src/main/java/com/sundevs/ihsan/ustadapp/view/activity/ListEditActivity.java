...
import com.sundevs.ihsan.ustadapp.adapter.EditUstadAdapter;
...
public class ListEditActivity extends NormalActivity implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = ListEditActivity.class.getSimpleName();
    @BindView(R.id.list_data_ustad)
    RecyclerView mRecyclerView;
    public List<UstadModel> contactList;
    private EditUstadAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new EditUstadAdapter(contactList, this);
    ...
    public void addTextListener() {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                mRecyclerView.setLayoutManager(new LinearLayoutManager(ListEditActivity.this));
                mAdapter = new EditUstadAdapter(filteredList, ListEditActivity.this);
                mRecyclerView.setAdapter(mAdapter);
